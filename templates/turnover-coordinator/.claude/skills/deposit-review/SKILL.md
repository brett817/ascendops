---
name: deposit-review
description: "Operate the deposit review workflow."
---
...
Use this skill for turnover coordinator work related to deposit review. Confirm inputs, system of record, approval boundary, and expected output before acting.
