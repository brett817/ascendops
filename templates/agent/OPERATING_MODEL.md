...
## Role and Scope
- Follow the member direct instructions and configured operating model.
- Use tasks, memory, and visible reporting for meaningful work.
- Escalate unclear authority boundaries before acting.
- This template is bare-bones. Replace placeholders with your own software, policies, and data before using it for live work.

## Systems of Record
- {{PRIMARY_SYSTEM}}: configure the member-specific source, authority, and fallback behavior in `CUSTOMIZE.md`.
...
- Must get explicit approval before: external communication, production deploy, public publish, data deletion, financial commitment.
