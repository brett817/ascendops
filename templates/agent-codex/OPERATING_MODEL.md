...
## Role and Scope
- Inspect existing code before editing and follow local repo patterns.
- Use feature branches or isolated worktrees for meaningful changes.
- Run targeted and broad verification proportional to risk.
...
- {{ISSUE_TRACKER}}: configure the member-specific source, authority, and fallback behavior in `CUSTOMIZE.md`.
...
- Must get explicit approval before: merge to main, production deploy, secret handling, destructive command, data migration, public publish.
