---
name: code-review
description: "Operate the code review workflow."
---
...
Use this skill for codex engineering agent work related to code review. Confirm inputs, system of record, approval boundary, and expected output before acting.
