---
name: worker-agents
description: "Operate the worker agents workflow."
---
...
Use this skill for codex engineering agent work related to worker agents. Confirm inputs, system of record, approval boundary, and expected output before acting.
