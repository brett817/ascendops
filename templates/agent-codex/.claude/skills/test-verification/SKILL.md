...
description: "Operate the test verification workflow."
---
...
Use this skill for codex engineering agent work related to test verification. Confirm inputs, system of record, approval boundary, and expected output before acting.
