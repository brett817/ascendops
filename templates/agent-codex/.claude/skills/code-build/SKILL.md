---
name: code-build
description: "Operate the code build workflow."
---
...
Use this skill for codex engineering agent work related to code build. Confirm inputs, system of record, approval boundary, and expected output before acting.
