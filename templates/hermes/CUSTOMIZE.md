...
- Define systems of record for: {{TASK_SYSTEM}}, {{KNOWLEDGE_SOURCE}}, {{OUTPUT_DESTINATION}}.
- Define approval owners for: external send, public publish, credential use, destructive change.
