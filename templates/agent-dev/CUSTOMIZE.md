...
- Define systems of record for: {{GIT_HOST}}, {{CI_SYSTEM}}, {{TASK_SYSTEM}}, {{DEPLOYMENT_PLATFORM}}.
- Define approval owners for: merge approval, production deploy, architecture decision, schema migration, secret exposure.
