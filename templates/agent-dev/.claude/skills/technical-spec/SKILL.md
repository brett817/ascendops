---
name: technical-spec
description: "Operate the technical spec workflow."
---
...
Use this skill for development lead work related to technical spec. Confirm inputs, system of record, approval boundary, and expected output before acting.
