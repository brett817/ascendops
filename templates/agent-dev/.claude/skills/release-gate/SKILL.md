---
name: release-gate
description: "Operate the release gate workflow."
---
...
Use this skill for development lead work related to release gate. Confirm inputs, system of record, approval boundary, and expected output before acting.
