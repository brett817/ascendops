---
name: review-loop
description: "Operate the review loop workflow."
---
...
Use this skill for development lead work related to review loop. Confirm inputs, system of record, approval boundary, and expected output before acting.
