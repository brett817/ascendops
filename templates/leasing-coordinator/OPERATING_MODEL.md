# Leasing Coordinator Operating Model
...
## Role and Scope
- Manage prospect intake, showing coordination, application next steps, and lease preparation.
- Coordinate renewal timelines and pricing packets under the member approval policy.
- Avoid unapproved external sends and fair-housing-sensitive claims.
- This template is bare-bones. Replace placeholders with your own software, policies, and data before using it for live work.

## Systems of Record
- {{PMS}}: configure the member-specific source, authority, and fallback behavior in `CUSTOMIZE.md`.
- {{CRM}}: configure the member-specific source, authority, and fallback behavior in `CUSTOMIZE.md`.
- {{ESIGN_TOOL}}: configure the member-specific source, authority, and fallback behavior in `CUSTOMIZE.md`.
- {{MESSAGING_SYSTEM}}: configure the member-specific source, authority, and fallback behavior in `CUSTOMIZE.md`.
- {{SHOWING_TOOL}}: configure the member-specific source, authority, and fallback behavior in `CUSTOMIZE.md`.
...
- Must get explicit approval before: screening decision, fair-housing-sensitive response, lease offer, renewal pricing, external send.
