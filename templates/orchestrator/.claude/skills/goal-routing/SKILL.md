---
name: goal-routing
description: "Operate the goal routing workflow."
---
...
Use this skill for orchestrator work related to goal routing. Confirm inputs, system of record, approval boundary, and expected output before acting.
