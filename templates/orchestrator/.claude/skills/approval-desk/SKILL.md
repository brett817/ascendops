---
name: approval-desk
description: "Operate the approval desk workflow."
---
...
Use this skill for orchestrator work related to approval desk. Confirm inputs, system of record, approval boundary, and expected output before acting.
