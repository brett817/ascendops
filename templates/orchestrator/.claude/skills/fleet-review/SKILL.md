---
name: fleet-review
description: "Operate the fleet review workflow."
---
...
Use this skill for orchestrator work related to fleet review. Confirm inputs, system of record, approval boundary, and expected output before acting.
