...
`SKOOL-INSTALL.md` in the platform project root (delivered by a successful
...
### Optional remote support access

Ask the operator whether they want to enable remote operator support access for this
