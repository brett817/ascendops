...
description: "Operate the owner statements workflow."
---
...
Use this skill for accounting coordinator work related to owner statements. Confirm inputs, system of record, approval boundary, and expected output before acting.
