...
description: "Operate the vendor payables workflow."
---
...
Use this skill for accounting coordinator work related to vendor payables. Confirm inputs, system of record, approval boundary, and expected output before acting.
