---
name: trend-scout
description: "Operate the trend scout workflow."
---
...
Use this skill for analyst work related to trend scout. Confirm inputs, system of record, approval boundary, and expected output before acting.
