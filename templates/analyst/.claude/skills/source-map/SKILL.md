---
name: source-map
description: "Operate the source map workflow."
---
...
Use this skill for analyst work related to source map. Confirm inputs, system of record, approval boundary, and expected output before acting.
